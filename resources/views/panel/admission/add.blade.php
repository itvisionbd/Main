                          ...
                          <tbody>
                            ...
                            <option value="HRDIT">HRDIT</option>
                             ...
                             <tr>
                                ...
                                <td>
                                   <select class="form-control" id="branch" name="branch_id" @if($user->role_id === 2) disabled @endif>
                @foreach($branches as $branch)
                    <option value="{{ $branch->id }}" @if($user->role_id === 2 && $branch->id === $user->branch_id) selected @endif>
                        {{ $branch->name }}
                    </option>
                @endforeach
            </select>

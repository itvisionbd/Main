            ...
            <div class="card-body">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" value="{{ $getRecord->pages_name }}" name="pages_name" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                   <select class="form-control" value="{{ $getRecord->parent_page_id }}" name="parent_page_id" required>
                     <option value="">Select</option>
                      @foreach($getParent as $value)
                     <option {{ ($getRecord->parent_page_id  == $value->id) ? 'selected' : '' }}  
                      value="{{ $value->id}}">{{ $value->parent_page_name}}</option>
                     @endforeach
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="file"  class="form-control" name="pages_file" >
                    @if(!empty($getRecord->pages_file))
                    <img src="{{ url('public/upload/' .$getRecord->pages_file) }}" style="height:70px; width: auto;">
                      @endif
                  </div>

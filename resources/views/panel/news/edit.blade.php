            ...
            <div class="card-body">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="{{ $getRecord->news_title }}"  class="form-control" name="news_title" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control"  name="news_shortdescription" required>
                     {{ $getRecord->news_shortdescription }}
                    </textarea>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control "  id="news_longdescription"  style="height: 100px" name="news_longdescription" required>  {{ $getRecord->news_longdescription }}
                    </textarea>
                  </div>
                </div>

                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label"> News File</label>
                  <div class="col-sm-10">
                    <input type="file" value="{{ $getRecord->news_file }}" class="form-control" name="news_file" required>
                    <iframe height="100"  width="100" src="{{ url('public/upload/' .$getRecord->news_file) }}"></iframe>
                  </div>
                </div>
                ...
                <fieldset class="row mb-3">
                  <legend class="col-form-label col-sm-2 pt-0">News Status</legend>
                  <div class="col-sm-10">                    

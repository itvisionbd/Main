            ...
            <div class="card-body">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="{{ $getRecord->course_title }}"  class="form-control" name="course_title" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="{{ $getRecord->course_fee }}" class="form-control" name="course_fee" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="{{ $getRecord->course_instructor }}" class="form-control" name="course_instructor" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="file" value="{{ $getRecord->course_title }}" class="form-control" name="course_file" required>
                  </div>
                </div>

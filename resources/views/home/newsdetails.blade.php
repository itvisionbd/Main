        ...
        <div class="container">
           <div class="row">
               ...
               <div class="col-lg-8 pt-15" >
                <h3 style="text-align: center;">{{ $getNews->news_title }}</h3>
                  <div class="blog-details mt-30">
                      <div class="thum">

                          <img src="{{ url('public/upload/' .$getNews->news_file)}}" class="img-fluid" alt="Responsive image">
                      </div>
                      <div class="cont">
                          

                           <p>{!! $getNews->news_longdescription !!}</p>
                      </div> <!-- cont -->
                  </div> <!-- blog details -->
              </div>
               <div class="col-lg-4">
